...
final class ProjectionTests: XCTestCase {
    ...
    func testProjectToEpsg3857() {
        let projection1 = Coordinate3D(latitude: 20.5, longitude: 10.5).projectedToEpsg3857
        ...
        let projection2 = Coordinate3D(latitude: 45.0, longitude: -180.0).projectedToEpsg3857
        ...
        let projection3 = Coordinate3D(latitude: -45.0, longitude: 45.0).projectedToEpsg3857
    ...
    func testProjectToEpsg4326() {
        let projection1 = ProjectedCoordinate(latitude: 2332357.812619, longitude: 1168854.653329, projection: .epsg3857).projectedToEpsg4326
        XCTAssertEqual(projection1.latitude, 20.5, accuracy: 0.00001)
        XCTAssertEqual(projection1.longitude, 10.5, accuracy: 0.00001)

        let projection2 = ProjectedCoordinate(latitude: 5621521.486192, longitude: -20037508.342789, projection: .epsg3857).projectedToEpsg4326
        XCTAssertEqual(projection2.latitude, 45.0, accuracy: 0.00001)
        XCTAssertEqual(projection2.longitude, -180.0, accuracy: 0.00001)

        let projection3 = ProjectedCoordinate(latitude: -5621521.49, longitude: 5009377.09, projection: .epsg3857).projectedToEpsg4326
